...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <a class="navbar-brand" href="http://szaboszabolcs.nhely.hu/"> Szabó Szabolcs - Webáruház</a>
...
$sql = "SELECT * FROM termek Where kategoria = 'ventillator'";
$eredmeny = mysqli_query($kapcsolat, $sql);


// A lekérdezés kiíratása
print("<H2>A webáruház tartalma - HŰTŐ</H2>");
...
// Az eredménytábla mezőneveinek kiíratása
		...
		//print("<th style= \"width: 2%\">fotonk</th>");
...
while ($sor = mysqli_fetch_array($eredmeny,MYSQLI_ASSOC))
	{
		...
		foreach ($sor as $i=>$ertek)
		{
			...
			if ($mezo_szamlalo == 5)
				print("<td><a href=\"fotok/$sor[foto_nk]\" target=\"_blank\"><img src=\"webaruhaz_termekei/fotok/$ertek\"fotok/$ertek\" alt=\"\" height=\"200\" widht=\"300\" style=\"max-width=\"300\"\"></a></td>");
			//if ($mezo_szamlalo == 6)
				//print("<td><a href=\"fotoknk/$ertek\" target=\"_blank\">nagykép</a></td>");
			if ($mezo_szamlalo == 7) 
